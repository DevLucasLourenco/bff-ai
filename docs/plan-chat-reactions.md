...
| --- | --- | --- |
| 1. Chat central | Posicionar `CharacterStage` na margem esquerda, próximo das respostas; manter mensagens e composer centrados no mesmo eixo; retirar miniaturas das mensagens | Abrir conversa com e sem visual, medir o espaço entre personagem e mensagens e comparar o centro das mensagens e do composer |
...
| 4. Layout | Usar margem esquerda no desktop e lateral esquerda do cabeçalho em telas estreitas; estilizar rolagem com trilho transparente; expandir o card Fashion durante edição sem rolagem horizontal | Conferir composer, edição de card Fashion, aviso, scrollbar e viewport estreito |
