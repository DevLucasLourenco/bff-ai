...
const RULES: { reaction: Reaction; pattern: RegExp }[] = [
  ...
  { reaction: 'pedindo_desculpas', pattern: /\bops\b|cometi um erro|errei|vou corrigir/ },
  ...
  { reaction: 'piscando_brincando', pattern: /entre nos|um segredinho|vou te contar um segredo/ },
